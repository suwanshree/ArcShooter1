...
def rotate_ship(ship):
    new_ship = pygame.transform.rotozoom(ship, -ship_movement * 6, 1)
    return new_ship
...
icon = pygame.image.load('.icon\\assets/icon0.png')
pygame.display.set_icon(icon)
counter = 0

bg_surface1 = pygame.image.load('.img\\assets/shooterbkg2.png').convert()
bg_surface2 = pygame.image.load('.img\\assets/shooterbkg3.png').convert()
bg_surface3 = pygame.image.load('.img\\assets/shooterbkg4.png').convert()
bg_surface4 = pygame.image.load('.img\\assets/shooterbkg5.png').convert()
floor_surface = pygame.image.load('.img\\assets/movingbkg.png').convert_alpha()
cloud1_surface = pygame.image.load('.img\\assets/cloud.png').convert_alpha()
cloud2_surface = pygame.image.load('.img\\assets/cloud1.png').convert_alpha()
floor_x_pos = 0
cloud1_x_pos = 1280
cloud2_x_pos = 2000

ship_downvec = pygame.image.load('.img\\assets/ship1.png').convert_alpha()
ship_downvec = pygame.transform.scale(ship_downvec, (80, 20))
ship_midvec = pygame.image.load('.img\\assets/ship2.png').convert_alpha()
ship_midvec = pygame.transform.scale(ship_midvec, (80, 20))
ship_upvec = pygame.image.load('.img\\assets/ship3.png').convert_alpha()
...
building1 = pygame.image.load('.img\\assets/build1.png').convert_alpha()
...
building2 = pygame.image.load('.img\\assets/build2.png').convert_alpha()
...
building3 = pygame.image.load('.img\\assets/build3.png').convert_alpha()
...
bogey1_downvec = pygame.image.load('.img\\assets/bogey1a.png').convert_alpha()
bogey1_midvec = pygame.image.load('.img\\assets/bogey1b.png').convert_alpha()
bogey1_upvec = pygame.image.load('.img\\assets/bogey1c.png').convert_alpha()
...
game_over_surface = pygame.image.load('.img\\assets/gameover.png').convert_alpha()
